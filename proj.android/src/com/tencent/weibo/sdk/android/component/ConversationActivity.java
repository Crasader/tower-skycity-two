...
public class ConversationActivity extends Activity implements HttpCallback{
	...
	private View initview(){
		...
		layout_title.setBackgroundDrawable(BackGroudSeletor.getdrawble("tencentWeibo/up_bg2x", ConversationActivity.this));
		...
		editText.setBackgroundDrawable(BackGroudSeletor.getdrawble("tencentWeibo/huati_input2x", ConversationActivity.this));
		editText.setCompoundDrawablesWithIntrinsicBounds(BackGroudSeletor.getdrawble("tencentWeibo/huati_icon_hover2x", ConversationActivity.this), null, null, null);
		...
		listView.setDivider(BackGroudSeletor.getdrawble("tencentWeibo/table_lie_",
