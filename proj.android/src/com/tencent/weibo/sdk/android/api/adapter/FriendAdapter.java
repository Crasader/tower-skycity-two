...
public class FriendAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(final int groupPosition, final int childPosition,
			boolean isLastChild, View convertView, ViewGroup parent) {
	            ...
	            if (convertView==null) {
					...
					layout.setBackgroundDrawable(BackGroudSeletor.getdrawble("tencentWeibo/childbg_",
					ctx));
					...
					imageView.setImageDrawable(BackGroudSeletor.getdrawble("tencentWeibo/logo", ctx));
					...
					imageView_icon.setImageDrawable(BackGroudSeletor.getdrawble("tencentWeibo/logo", ctx));
					textView_name.setText(((Firend)getChild(groupPosition, childPosition)).getNick());
					textView_content.setText(((Firend)getChild(groupPosition, childPosition)).getName());
				}
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView==null) {
			...
			layout.setBackgroundDrawable(BackGroudSeletor.getdrawble("tencentWeibo/groupbg_",
					ctx));
